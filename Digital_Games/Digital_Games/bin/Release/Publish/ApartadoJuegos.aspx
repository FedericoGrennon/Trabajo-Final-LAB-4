...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="minHeight" style="background:url(https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/media/image/2013/01/205245-20-mejores-juegos-wii.jpg)no-repeat bottom;background-size:cover">
      <div class="row">
        <div class="column-66">
          ...
          <button class="boton">Download Application</button>
        </div>
      </div>
    </div>

    <div class="minHeight" style="background:url(https://cdn4.areajugones.es/wp-content/uploads/2017/04/counter-strike-global-offensive-810x400.png)no-repeat bottom;background-size:cover">
      <div class="row">
        <div class="column-66" style="text-align:right; float: right">
          ...
          <button class="boton" style="background-color:red">Read More</button>
        </div>
      </div>
    </div>

    <div class="minHeight" style="background:url(https://d2skuhm0vrry40.cloudfront.net/2018/articles/2018-07-30-11-26/titan-quest-review-not-all-switch-ports-are-created-equal-1532946388292.jpg/EG11/thumbnail/1920x1080/format/jpg/1987099.jpg)no-repeat bottom;background-size:cover">
      <div class="row">
        <div class="column-66">
          <h1 class="xlarge-font"><b>The App</b></h1>
          <h1 class="large-font" style="color:MediumSeaGreen;"><b>Why buy it?</b></h1>
